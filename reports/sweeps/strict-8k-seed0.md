...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| calibration/uncalibrated | 6000 | 0.5537 | 0.0303 | 0.0364 | 0.5154 | 4.0 | 6.3 | 117 |
| calibration/temperature-scaled | 6000 | 0.5537 | 0.0297 | 0.0362 | 0.5154 | 4.0 | 6.3 | 117 |
| calibration/int8 | 6000 | 0.5537 | 0.0296 | 0.0368 | 0.5154 | 4.0 | 6.5 | 117 |

## Release gates

- PASS sample_size: 18000.0000 (limit 5000.0000) -- below this, ECE is dominated by estimator noise
- PASS gate_is_testable: 0.0095 (limit 0.0250) -- a perfectly calibrated model scores ECE 0.0062 on this run, p95 0.0095
...
- PASS workhorse_ece: 0.0297 (limit 0.0500)
- PASS workhorse_adaptive_ece: 0.0362 (limit 0.0500)
...
| --- | ---: | ---: | ---: | ---: | ---: |
| accounts | 18000 | 0.554 | 0.557 | +0.004 | 0.0297 |

## Per-primitive calibration

| Primitive | n | Accuracy | Mean confidence | Overconfidence | ECE |
| --- | ---: | ---: | ---: | ---: | ---: |
| choice | 6000 | 0.648 | 0.609 | -0.039 | 0.0392 |
