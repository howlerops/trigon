...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| calibration/uncalibrated | 6000 | 0.5866 | 0.0431 | 0.0822 | 0.4943 | 4.0 | 7.5 | 117 |
| calibration/temperature-scaled | 6000 | 0.5866 | 0.0516 | 0.0498 | 0.4922 | 4.0 | 6.9 | 117 |
| calibration/int8 | 6000 | 0.5866 | 0.0516 | 0.0496 | 0.4922 | 4.0 | 6.6 | 117 |

## Release gates

- PASS sample_size: 18000.0000 (limit 5000.0000) -- below this, ECE is dominated by estimator noise
- PASS gate_is_testable: 0.0096 (limit 0.0250) -- a perfectly calibrated model scores ECE 0.0059 on this run, p95 0.0096
...
- PASS workhorse_adaptive_ece: 0.0498 (limit 0.0500)
- PASS quantization_ece_delta: 0.0000 (limit 0.0100)

**Blocked**: workhorse_ece.
...
| --- | ---: | ---: | ---: | ---: | ---: |
| accounts | 18000 | 0.587 | 0.585 | -0.001 | 0.0516 |
