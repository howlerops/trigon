...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| calibration/uncalibrated | 6000 | 0.5537 | 0.0303 | 0.0364 | 0.5154 | 3.9 | 6.3 | 117 |
| calibration/temperature-scaled | 6000 | 0.5537 | 0.0128 | 0.0334 | 0.5126 | 3.9 | 6.8 | 117 |
| calibration/int8 | 6000 | 0.5537 | 0.0128 | 0.0222 | 0.5126 | 3.9 | 6.5 | 117 |

## Release gates

- PASS sample_size: 18000.0000 (limit 5000.0000) -- below this, ECE is dominated by estimator noise
- PASS gate_is_testable: 0.0102 (limit 0.0250) -- a perfectly calibrated model scores ECE 0.0064 on this run, p95 0.0102
...
- PASS workhorse_ece: 0.0128 (limit 0.0500)
...
| --- | ---: | ---: | ---: | ---: | ---: |
| accounts | 18000 | 0.554 | 0.545 | -0.009 | 0.0128 |
