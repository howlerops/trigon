...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| calibration/uncalibrated | 6000 | 0.6194 | 0.0096 | 0.0110 | 0.4629 | 4.2 | 6.2 | 117 |
| calibration/temperature-scaled | 6000 | 0.6194 | 0.0083 | 0.0106 | 0.4629 | 4.2 | 6.3 | 117 |
| calibration/int8 | 6000 | 0.6194 | 0.0083 | 0.0108 | 0.4629 | 4.3 | 6.4 | 117 |

## Release gates

- PASS sample_size: 18000.0000 (limit 5000.0000) -- below this, ECE is dominated by estimator noise
- PASS gate_is_testable: 0.0069 (limit 0.0250) -- a perfectly calibrated model scores ECE 0.0047 on this run, p95 0.0069
...
| --- | ---: | ---: | ---: | ---: | ---: |
| accounts | 18000 | 0.619 | 0.621 | +0.002 | 0.0083 |
