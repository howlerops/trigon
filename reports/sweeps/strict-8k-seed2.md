...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| calibration/uncalibrated | 6000 | 0.6194 | 0.0096 | 0.0110 | 0.4629 | 4.2 | 6.3 | 117 |
| calibration/temperature-scaled | 6000 | 0.6194 | 0.0096 | 0.0110 | 0.4629 | 4.2 | 6.2 | 117 |
| calibration/int8 | 6000 | 0.6194 | 0.0096 | 0.0112 | 0.4629 | 4.2 | 6.1 | 117 |

## Release gates

- PASS sample_size: 18000.0000 (limit 5000.0000) -- below this, ECE is dominated by estimator noise
- PASS gate_is_testable: 0.0069 (limit 0.0250) -- a perfectly calibrated model scores ECE 0.0045 on this run, p95 0.0069
...
- PASS workhorse_adaptive_ece: 0.0110 (limit 0.0500)
...
| --- | ---: | ---: | ---: | ---: | ---: |
| accounts | 18000 | 0.619 | 0.622 | +0.002 | 0.0096 |

## Per-primitive calibration

| Primitive | n | Accuracy | Mean confidence | Overconfidence | ECE |
| --- | ---: | ---: | ---: | ---: | ---: |
| choice | 6000 | 0.849 | 0.856 | +0.007 | 0.0066 |
