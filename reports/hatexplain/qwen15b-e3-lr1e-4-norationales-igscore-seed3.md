...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hatexplain/uncalibrated | 5000 | 0.6966 | 0.0268 | 0.0276 | 0.4090 | 50.9 | 61.4 | 92 |
| hatexplain/calibrated | 5000 | 0.6772 | 0.0300 | 0.0251 | 0.4145 | 49.5 | 60.2 | 92 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| model | `gradient_x_input` | 2,948 | 0.2998 | 0.5005 | 0.3154 | 0.2243 | 0.149 | 0.340 |
| model, integrated gradients | `integrated_gradients` | 2,948 | 0.3849 | 0.6083 | 0.3889 | 0.3189 | 0.143 | 0.340 |
...
Integrated gradients' completeness on the first 200 of these cases (32 points, `u ** 3` spacing): relative error of the summed attributions against the log-probability difference they must add up to, median 0.7793, p90 4.4983, max 19.8608, over the 200 whose difference is at least 0.01 nats (median difference 4.734). A large error means too few points, and the `integrated gradients` row is then a quadrature artefact, not the method.
