...
```
python scripts/train_corpus.py hatexplain -n 0 --calibration-n 1000 --eval-n 0 --epochs 3 --lr 0.0001 --accumulate 8 --d-model 128 --layers 2 --seed 3 --device cuda --backbone qwen2.5-1.5b --lora-rank 16 --max-batch-cells 50000000
```
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hatexplain/uncalibrated | 5000 | 0.6930 | 0.0237 | 0.0209 | 0.4086 | 51.3 | 56.9 | 92 |
| hatexplain/calibrated | 5000 | 0.6930 | 0.0237 | 0.0209 | 0.4086 | 50.3 | 53.8 | 92 |
...
- PASS worst_question_over_baseline: 0.2826 (limit 0.0500) -- worst is 'label' at 0.6930 vs its own marginal 0.4104; the pooled gate hides this
- PASS workhorse_ece: 0.0237 (limit 0.0500)
- PASS workhorse_adaptive_ece: 0.0209 (limit 0.0500)
- PASS worst_primitive_workhorse_ece: 0.0237 (limit 0.0500) -- worst is 'choice' at ECE 0.0237 (overconfidence -0.016); pooled ECE cancels heads that err in opposite directions
...
| model, gradient x input | `gradient_x_input` | 2,948 | 0.3030 | 0.5020 | 0.3130 | 0.2336 | 0.149 | 0.340 |
