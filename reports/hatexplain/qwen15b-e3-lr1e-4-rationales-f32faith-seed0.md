...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hatexplain/uncalibrated | 5000 | 0.6970 | 0.0271 | 0.0261 | 0.4102 | 49.8 | 52.3 | 92 |
| hatexplain/calibrated | 5000 | 0.6970 | 0.0271 | 0.0261 | 0.4102 | 49.8 | 52.7 | 92 |
...
| model, gradient x input | `gradient_x_input` | 2,960 | 0.2864 | 0.4949 | 0.2953 | 0.2095 | 0.147 | 0.339 |
| model, integrated gradients | `integrated_gradients` | 2,960 | 0.3638 | 0.5771 | 0.3784 | 0.3055 | 0.148 | 0.339 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| model, span head | `span_head` | 500 | 0.3457 | +0.2729 ± 0.0289 | +0.0171 ± 0.0066 | 0.0823 | -0.2431 ± 0.0301 | -0.0096 ± 0.0080 | 0.6652 |
| model, gradient x input | `gradient_x_input` | 500 | 0.2165 | +0.1438 ± 0.0222 | -0.1121 ± 0.0240 | 0.1819 | -0.1435 ± 0.0234 | +0.0901 ± 0.0235 | 0.6652 |
| model, integrated gradients | `integrated_gradients` | 500 | 0.2923 | +0.2196 ± 0.0222 | -0.0363 ± 0.0225 | 0.1093 | -0.2161 ± 0.0229 | +0.0174 ± 0.0204 | 0.6652 |
| rationale lexicon | `fitted word list` | 500 | 0.3286 | +0.2558 ± 0.0283 | — | 0.0918 | -0.2336 ± 0.0292 | — | 0.6652 |
| random | `random` | 500 | 0.0728 | — | -0.2558 ± 0.0283 | 0.3254 | — | +0.2336 ± 0.0292 | 0.6652 |

| Highlighter, comprehensiveness / sufficiency | 1% | 5% | 10% | 20% | 50% |
| --- | ---: | ---: | ---: | ---: | ---: |
| model, span head | 0.252 / 0.148 | 0.301 / 0.109 | 0.357 / 0.078 | 0.398 / 0.046 | 0.421 / 0.030 |
| model, gradient x input | 0.131 / 0.296 | 0.161 / 0.252 | 0.204 / 0.187 | 0.245 / 0.129 | 0.341 / 0.046 |
| model, integrated gradients | 0.197 / 0.231 | 0.235 / 0.177 | 0.281 / 0.104 | 0.331 / 0.044 | 0.417 / -0.009 |
| rationale lexicon | 0.234 / 0.173 | 0.283 / 0.117 | 0.344 / 0.078 | 0.380 / 0.052 | 0.402 / 0.040 |
| random | 0.023 / 0.397 | 0.029 / 0.389 | 0.048 / 0.357 | 0.080 / 0.304 | 0.184 / 0.179 |

Cost: 19,349 re-asks in 150.3 s (batches of 16), 649.7 s with attribution.
