...
```
python scripts/train_corpus.py hatexplain -n 0 --calibration-n 1000 --eval-n 0 --epochs 3 --lr 0.0001 --accumulate 8 --d-model 128 --layers 2 --seed 0 --device cuda --backbone qwen2.5-1.5b --lora-rank 16 --max-batch-cells 50000000 --rationale-weight 0.0
```
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hatexplain/uncalibrated | 5000 | 0.6478 | 0.0224 | 0.0203 | 0.4582 | 55.2 | 94.2 | 92 |
| hatexplain/calibrated | 5000 | 0.6478 | 0.0224 | 0.0203 | 0.4582 | 55.5 | 105.0 | 92 |
...
- PASS worst_question_over_baseline: 0.2400 (limit 0.0500) -- worst is 'label' at 0.6478 vs its own marginal 0.4078; the pooled gate hides this
- PASS workhorse_ece: 0.0224 (limit 0.0500)
- PASS workhorse_adaptive_ece: 0.0203 (limit 0.0500)
- PASS worst_primitive_workhorse_ece: 0.0224 (limit 0.0500) -- worst is 'choice' at ECE 0.0224 (overconfidence -0.006); pooled ECE cancels heads that err in opposite directions
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| model | `gradient_x_input` | 2,960 | 0.2778 | 0.4824 | 0.2841 | 0.2202 | 0.138 | 0.339 |
