...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hatexplain/uncalibrated | 5000 | 0.6864 | 0.0193 | 0.0257 | 0.4198 | 49.3 | 57.2 | 92 |
| hatexplain/calibrated | 5000 | 0.6854 | 0.0272 | 0.0285 | 0.4232 | 49.2 | 67.1 | 92 |
...
| model, gradient x input | `gradient_x_input` | 2,956 | 0.3033 | 0.5177 | 0.3081 | 0.2358 | 0.142 | 0.337 |
| model, integrated gradients | `integrated_gradients` | 2,956 | 0.3839 | 0.6124 | 0.3850 | 0.3214 | 0.143 | 0.337 |
...
Integrated gradients' completeness on the first 200 of these cases (32 points, `u ** 3` spacing): relative error of the summed attributions against the log-probability difference they must add up to, median 1.5615, p90 7.4237, max 46.1112, over the 199 whose difference is at least 0.01 nats (median difference 1.997). A large error means too few points, and the `integrated gradients` row is then a quadrature artefact, not the method.
