...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hatexplain/uncalibrated | 5000 | 0.6864 | 0.0193 | 0.0257 | 0.4198 | 55.5 | 60.9 | 92 |
| hatexplain/calibrated | 5000 | 0.6854 | 0.0272 | 0.0285 | 0.4232 | 54.2 | 58.1 | 92 |
...
- PASS (advisory) worst_question_over_baseline: 0.2766 (limit 0.0500) -- worst is 'label' at 0.6854 vs its own marginal 0.4088; the pooled gate hides this
- PASS workhorse_ece: 0.0272 (limit 0.0500)
- PASS workhorse_adaptive_ece: 0.0285 (limit 0.0500)
- PASS (advisory) worst_primitive_workhorse_ece: 0.0272 (limit 0.0500) -- worst is 'choice' at ECE 0.0272 (overconfidence +0.027); pooled ECE cancels heads that err in opposite directions
...
| model, gradient x input | `gradient_x_input` | 2,956 | 0.2995 | 0.5148 | 0.3022 | 0.2305 | 0.142 | 0.337 |
| model, integrated gradients | `integrated_gradients` | 2,956 | 0.3927 | 0.6246 | 0.3940 | 0.3376 | 0.144 | 0.337 |
...
Integrated gradients' completeness on the first 200 of these cases (32 points, `u ** 3` spacing, float32 path): relative error of the summed attributions against the log-probability difference they must add up to, median 1.0720, p90 6.3337, max 26.8781, over the 196 whose difference is at least 0.01 nats (median difference 1.219). A large error means too few points or too little precision, and the `integrated gradients` row is then an artefact of the arithmetic, not the method.
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| model, span head | `span_head` | 500 | 0.3309 | +0.2582 ± 0.0269 | +0.0146 ± 0.0072 | 0.0882 | -0.2225 ± 0.0268 | -0.0090 ± 0.0082 | 0.6471 |
| model, gradient x input | `gradient_x_input` | 500 | 0.2076 | +0.1349 ± 0.0210 | -0.1088 ± 0.0221 | 0.1803 | -0.1305 ± 0.0207 | +0.0831 ± 0.0204 | 0.6471 |
| model, integrated gradients | `integrated_gradients` | 500 | 0.3116 | +0.2389 ± 0.0212 | -0.0047 ± 0.0188 | 0.0777 | -0.2330 ± 0.0211 | -0.0194 ± 0.0167 | 0.6471 |
| rationale lexicon | `fitted word list` | 500 | 0.3163 | +0.2436 ± 0.0262 | — | 0.0972 | -0.2136 ± 0.0262 | — | 0.6471 |
| random | `random` | 500 | 0.0727 | — | -0.2436 ± 0.0262 | 0.3107 | — | +0.2136 ± 0.0262 | 0.6471 |

| Highlighter, comprehensiveness / sufficiency | 1% | 5% | 10% | 20% | 50% |
| --- | ---: | ---: | ---: | ---: | ---: |
| model, span head | 0.250 / 0.150 | 0.294 / 0.124 | 0.337 / 0.088 | 0.377 / 0.057 | 0.397 / 0.023 |
| model, gradient x input | 0.123 / 0.286 | 0.151 / 0.251 | 0.192 / 0.195 | 0.241 / 0.125 | 0.330 / 0.044 |
| model, integrated gradients | 0.242 / 0.164 | 0.272 / 0.128 | 0.300 / 0.081 | 0.344 / 0.027 | 0.400 / -0.011 |
| rationale lexicon | 0.231 / 0.175 | 0.279 / 0.133 | 0.326 / 0.087 | 0.364 / 0.063 | 0.382 / 0.028 |
| random | 0.029 / 0.368 | 0.031 / 0.363 | 0.036 / 0.347 | 0.072 / 0.305 | 0.196 / 0.170 |

Cost: 18,561 re-asks in 158.9 s (batches of 16), 656.0 s with attribution.
