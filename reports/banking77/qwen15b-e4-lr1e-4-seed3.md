...
```
python scripts/train_corpus.py banking77 -n 0 --calibration-n 1000 --eval-n 0 --epochs 4 --lr 0.0001 --accumulate 8 --d-model 128 --layers 2 --seed 3 --device cuda --backbone qwen2.5-1.5b --lora-rank 16 --max-batch-cells 50000000
```
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| banking77/uncalibrated | 5000 | 0.8538 | 0.0195 | 0.0174 | 0.2144 | 59.9 | 69.4 | 298 |
| banking77/calibrated | 5000 | 0.8502 | 0.0105 | 0.0106 | 0.2174 | 59.4 | 64.8 | 298 |
