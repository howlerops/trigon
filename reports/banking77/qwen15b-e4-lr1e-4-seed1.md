...
```
python scripts/train_corpus.py banking77 -n 0 --calibration-n 1000 --eval-n 0 --epochs 4 --lr 0.0001 --accumulate 8 --d-model 128 --layers 2 --seed 1 --device cuda --backbone qwen2.5-1.5b --lora-rank 16 --max-batch-cells 50000000
```
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| banking77/uncalibrated | 5000 | 0.8980 | 0.0448 | 0.0445 | 0.1618 | 56.7 | 59.2 | 298 |
| banking77/calibrated | 5000 | 0.8980 | 0.0448 | 0.0445 | 0.1618 | 56.3 | 58.6 | 298 |
