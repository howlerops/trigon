...
```
python scripts/train_corpus.py banking77 -n 0 --calibration-n 1000 --eval-n 0 --epochs 6 --lr 0.0003 --accumulate 8 --d-model 128 --layers 2 --seed 1
```
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| banking77/uncalibrated | 5000 | 0.7176 | 0.0361 | 0.0382 | 0.3892 | 35.6 | 67.2 | 608 |
| banking77/calibrated | 5000 | 0.7176 | 0.0361 | 0.0382 | 0.3892 | 35.3 | 84.0 | 608 |
