...
```
python scripts/train_corpus.py banking77 -n 0 --calibration-n 1000 --eval-n 0 --epochs 4 --lr 0.0001 --accumulate 8 --d-model 128 --layers 2 --seed 2 --device cuda --backbone qwen2.5-1.5b --lora-rank 16 --max-batch-cells 50000000
```
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| banking77/uncalibrated | 5000 | 0.9020 | 0.0534 | 0.0534 | 0.1530 | 61.3 | 65.2 | 298 |
| banking77/calibrated | 5000 | 0.9038 | 0.0216 | 0.0216 | 0.1476 | 61.4 | 65.4 | 298 |
