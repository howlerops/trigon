...
`1200` training cases, `5` epochs, lr `0.01`, d_model `128`, layers `2`, option scoring `auto`, label noise `0.2`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| calibration/uncalibrated | 6000 | 0.3914 | 0.0115 | 0.0503 | 0.6485 | 5.4 | 7.3 | 125 |
| calibration/temperature-scaled | 6000 | 0.3914 | 0.0171 | 0.0503 | 0.6490 | 5.3 | 6.5 | 125 |
...
On these 18000 predictions a perfectly calibrated model scores a mean ECE of 0.0037 (95th percentile 0.0063), simulated over 40 resamples. The measured ECE is 0.0115.
